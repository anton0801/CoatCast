...
struct SheenRig: UIViewRepresentable {
    let url: URL
    func makeCoordinator() -> SheenHand { SheenHand() }
    ...
    private func buildWebView(coordinator: SheenHand) -> WKWebView {
